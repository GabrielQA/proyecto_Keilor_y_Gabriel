 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos3p5 extends JFrame {
     JPanel[] Panelp;
    
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"JosueQA", "RicardoRA", "LoganNA"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos3p5 nadadoresHilos = new NadadoresHilos3p5();
    }
}
