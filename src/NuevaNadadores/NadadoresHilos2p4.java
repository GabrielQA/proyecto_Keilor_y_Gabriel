 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos2p4 extends JFrame {
     JPanel[] Panelp;
    int Carreras= 0;
     private javax.swing.JButton Estadisticas;
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"JosueQA", "RicardoRA", "StefanyFC", "LoganNA"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos2p4 nadadoresHilos = new NadadoresHilos2p4();
    }
}
