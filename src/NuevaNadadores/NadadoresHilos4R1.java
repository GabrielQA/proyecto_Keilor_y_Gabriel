 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos4R1 extends JFrame {
 QA variable = new QA();
 int nueva = variable.AA;
    ...
    String[] nombres = {"RicardoRA","StefanyFC"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos4R1 nadadoresHilos = new NadadoresHilos4R1();
    }
}
