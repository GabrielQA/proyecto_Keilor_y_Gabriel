 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos3p6 extends JFrame {
     JPanel[] Panelp;
    
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"JosueQA", "StefanyFC", "LoganNA"};
    JButton boton;
    JTextPane a;
    int Carreras= 0;
    ...
    public static void main(String[] args) {
        NadadoresHilos3p6 nadadoresHilos = new NadadoresHilos3p6();
    }
}
