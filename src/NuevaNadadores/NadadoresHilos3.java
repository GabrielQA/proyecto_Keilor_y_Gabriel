 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos3 extends JFrame {
     JPanel[] Panelp;
    
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"QuintoJugador", "CuartoJugador", "TercerJugador"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos3 nadadoresHilos = new NadadoresHilos3();
    }
}
