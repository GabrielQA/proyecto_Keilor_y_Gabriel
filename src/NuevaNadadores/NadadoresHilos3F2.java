 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos3F2 extends JFrame {
     JPanel[] Panelp;
    
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"FernandaSE", "RicardoRA", "LoganNA"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos3F2 nadadoresHilos = new NadadoresHilos3F2();
    }
}
