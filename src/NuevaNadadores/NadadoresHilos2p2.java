 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos2p2 extends JFrame {
     JPanel[] Panelp;
    int Carreras= 0;
     private javax.swing.JButton Estadisticas;
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"JosueQA", "FernandaSE", "RicardoRA", "LoganNA"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos2p2 nadadoresHilos = new NadadoresHilos2p2();
    }
}
