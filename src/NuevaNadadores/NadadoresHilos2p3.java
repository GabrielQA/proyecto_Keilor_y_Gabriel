 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos2p3 extends JFrame {
     JPanel[] Panelp;
    
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"JosueQA", "FernandaSE", "StefanyFC", "LoganNA"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos2p3 nadadoresHilos = new NadadoresHilos2p3();
    }
}
