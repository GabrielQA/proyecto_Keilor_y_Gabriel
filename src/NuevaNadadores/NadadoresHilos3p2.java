 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos3p2 extends JFrame {
     JPanel[] Panelp;
    
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"JosueQA", "FernandaSE", "StefanyFC"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos3p2 nadadoresHilos = new NadadoresHilos3p2();
    }
}
