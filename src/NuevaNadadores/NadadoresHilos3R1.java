 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos3R1 extends JFrame {
     JPanel[] Panelp;
    int Carreras= 0;
     private javax.swing.JButton Estadisticas;
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"RicardoRA", "StefanyFC", "LoganNA"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos3R1 nadadoresHilos = new NadadoresHilos3R1();
    }
}
