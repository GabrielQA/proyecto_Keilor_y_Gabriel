 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos4F2 extends JFrame {
 QA variable = new QA();
 int nueva = variable.AA;
    ...
    String[] nombres = {"FernandaSE","StefanyFC"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos4F2 nadadoresHilos = new NadadoresHilos4F2();
    }
}
