 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos4R2 extends JFrame {
 QA variable = new QA();
 int nueva = variable.AA;
  int Carreras= 0;
    ...
    String[] nombres = {"RicardoRA","LoganNA"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos4R2 nadadoresHilos = new NadadoresHilos4R2();
    }
}
