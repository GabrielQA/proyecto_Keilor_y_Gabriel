 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos4L1 extends JFrame {
 QA variable = new QA();
 int nueva = variable.AA;
    ...
    String[] nombres = {"StefanyFC","LoganNA"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
       NadadoresHilos4L1 nadadoresHilos = new NadadoresHilos4L1();
    }
}
