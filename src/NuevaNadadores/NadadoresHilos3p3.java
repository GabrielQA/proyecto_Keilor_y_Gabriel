 ...
 * @author GABRIEL-PC
 */
public class NadadoresHilos3p3 extends JFrame {
     JPanel[] Panelp;
    int Carreras= 0;
     private javax.swing.JButton Estadisticas;
    JPanel[] paneles;
    JLabel[] labels;
    String[] nombres = {"JosueQA", "FernandaSE", "LoganNA"};
    JButton boton;
    JTextPane a;
    ...
    public static void main(String[] args) {
        NadadoresHilos3p3 nadadoresHilos = new NadadoresHilos3p3();
    }
}
